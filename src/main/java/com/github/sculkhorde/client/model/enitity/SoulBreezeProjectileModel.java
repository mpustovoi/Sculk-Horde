...
public class SoulBreezeProjectileModel extends DefaultedEntityGeoModel<SoulBreezeProjectileEntity> { {
	...
	@Override
	public RenderType getRenderType(SoulBreezeProjectileEntity animatable, ResourceLocation texture) {
