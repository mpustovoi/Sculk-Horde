...
/**
 * The Only Reason this class exists is that mojang decided some important methods should be private.
 */
public final class ProjectileUtil {
    ...
    public static HitResult getHitResult(Vec3 p_278237_, Entity p_278320_, Predicate<Entity> p_278257_, Vec3 p_278342_, Level p_278321_) {
