...
public class CursorPurifierProberEntity extends CursorSurfaceInfectorEntity {
     ...
     */
    public CursorPurifierProberEntity(Level worldIn) {super(ModEntities.CURSOR_PROBER.get(), worldIn);}

    public CursorPurifierProberEntity(EntityType<?> pType, Level pLevel) {
        super(pType, pLevel);
    }
