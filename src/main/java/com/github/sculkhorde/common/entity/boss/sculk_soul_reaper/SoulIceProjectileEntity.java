...
public class SoulIceProjectileEntity extends AbstractProjectileEntity implements GeoEntity {
    public SoulIceProjectileEntity(EntityType<? extends Projectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        setNoGravity(true);
    }

    public SoulIceProjectileEntity(Level level, LivingEntity shooter, float damage)
    {
